...
# Comparing each selected predictor variable to selected outcome variable
  ...
  #For outcome ICU versus predictor race
    ...
    summary(glm(icu ~ race, data = race_wb, family = "binomial"))
    chisq.test(table(race_wb$icu, race_wb$race))
    
  #For outcome ICU versus predictor gender
    ggplot(COVID.clean, aes(x = icu, fill = gender)) +
        geom_bar(position = "dodge")
    summary(glm(icu ~ gender, data = COVID.clean, family = "binomial"))
    chisq.test(table(COVID.clean$icu, COVID.clean$gender))
    
     #For outcome ICU versus predictor Asthma
    ggplot(COVID.clean, aes(x = icu, fill = Asthma)) +
        geom_bar(position = "dodge")
    summary(glm(icu ~ Asthma, data = COVID.clean, family = "binomial"))
    chisq.test(table(COVID.clean$icu, COVID.clean$Asthma))
    
    
    #For outcome ICU versus predictor Obesity
    ggplot(COVID.clean, aes(x = icu, fill = Obesity)) +
        geom_bar(position = "dodge")
    summary(glm(icu ~ Obesity, data = COVID.clean, family = "binomial"))
    chisq.test(table(COVID.clean$icu, COVID.clean$Obesity))
    
     #For outcome ICU versus predictor Diabetes
    ggplot(COVID.clean, aes(x = icu, fill = Diabetes)) +
        geom_bar(position = "dodge")
    summary(glm(icu ~ Diabetes, data = COVID.clean, family = "binomial"))
    chisq.test(table(COVID.clean$icu, COVID.clean$Diabetes))
  ...
  #For outcome ventilator versus predictor race
    ggplot(race_wb, aes(x = ventilator, fill = race)) +
        geom_bar(position = "dodge")
    summary(glm(ventilator ~ race, data = race_wb, family = "binomial"))
  ...
  #For outcome ventilator versus predictor gender
    ggplot(COVID.clean, aes(x = ventilator, fill = gender)) +
        geom_bar(position = "dodge")
    summary(glm(ventilator ~ gender, data = COVID.clean, family = "binomial"))
    chisq.test(table(COVID.clean$ventilator, COVID.clean$gender))
    
     #For outcome ventilator versus predictor Asthma
    ggplot(COVID.clean, aes(x = ventilator, fill = Asthma)) +
        geom_bar(position = "dodge")
    summary(glm(ventilator ~ Asthma, data = COVID.clean, family = "binomial"))
    chisq.test(table(COVID.clean$ventilator, COVID.clean$Asthma))
    
    
    #For outcome ventilator versus predictor Obesity
    ggplot(COVID.clean, aes(x = ventilator, fill = Obesity)) +
        geom_bar(position = "dodge")
    summary(glm(ventilator ~ Obesity, data = COVID.clean, family = "binomial"))
    chisq.test(table(COVID.clean$ventilator, COVID.clean$Obesity))
    
     #For outcome ventilator versus predictor Diabetes
    ggplot(COVID.clean, aes(x = ventilator, fill = Diabetes)) +
        geom_bar(position = "dodge")
    summary(glm(ventilator ~ Diabetes, data = COVID.clean, family = "binomial"))
    chisq.test(table(COVID.clean$ventilator, COVID.clean$Diabetes))
    ...
    #For outcome ventilator versus obesity
     ggplot(COVID.clean, aes(x = ventilator, fill = Obesity)) +
        geom_bar(position = "dodge")
    summary(glm(ventilator ~ Obesity, data = COVID.clean, family = "binomial"))
    chisq.test(table(COVID.clean$ventilator, COVID.clean$Obesity))
  ...
  #For outcome deceased.status versus predictor race
    ggplot(race_wb, aes(x = deceased.status, fill = race)) +
        geom_bar(position = "dodge")
    summary(glm(deceased.status ~ race, data = race_wb, family = "binomial"))
  ...
  #For outcome deceased.status versus predictor gender
    ggplot(COVID.clean, aes(x = deceased.status, fill = gender)) +
        geom_bar(position = "dodge")
    summary(glm(deceased.status ~ gender, data = COVID.clean, family = "binomial"))
    chisq.test(table(COVID.clean$deceased.status, COVID.clean$gender))
    
     #For outcome deceased.status versus predictor Asthma
    ggplot(COVID.clean, aes(x = deceased.status, fill = Asthma)) +
        geom_bar(position = "dodge")
    summary(glm(deceased.status ~ Asthma, data = COVID.clean, family = "binomial"))
    chisq.test(table(COVID.clean$deceased.status, COVID.clean$Asthma))
    
    
    #For outcome deceased.status versus predictor Obesity
    ggplot(COVID.clean, aes(x = deceased.status, fill = Obesity)) +
        geom_bar(position = "dodge")
    summary(glm(deceased.status ~ Obesity, data = COVID.clean, family = "binomial"))
    chisq.test(table(COVID.clean$deceased.status, COVID.clean$Obesity))
    
     #For outcome deceased.status versus predictor Diabetes
    ggplot(COVID.clean, aes(x = deceased.status, fill = Diabetes)) +
        geom_bar(position = "dodge")
    summary(glm(deceased.status ~ Diabetes, data = COVID.clean, family = "binomial"))
    chisq.test(table(COVID.clean$deceased.status, COVID.clean$Diabetes))
    ...
    #For outcome deceased.status versus obesity
     ggplot(COVID.clean, aes(x = deceased.status, fill = Obesity)) +
        geom_bar(position = "dodge")
    summary(glm(deceased.status ~ Obesity, data = COVID.clean, family = "binomial"))
    chisq.test(table(COVID.clean$deceased.status, COVID.clean$Obesity))
